...
var next=0;			
	function showProvince(){
			...
			$("#pro").html("<ul class='clearfix ul_pro'><div class='closePro' onclick='closePro();'>完成</div>"+ss+"<li class='li_close' onclick='closePro();'><span>关闭</span></li><li class='li_clean' onclick='cleanPro();'><span>清空</span></li></ul>");
	} 
	function showKeybord(){
			...
			$("#pro").html("<ul class='clearfix ul_keybord'><div class='closePro' onclick='closePro();'>完成</div>"+sss+"</ul>");
	}
    ...
    function chooseProvince(obj){
    	$(obj).addClass('selected_s');
		setTimeout(() => {
			$(obj).removeClass('selected_s');
		}, 100)
